  ...
  return (
    <div>
      <div className="container mt-5">
        ...
        <div className="row row-cols-lg-2 row-cols-1 g-5 mt-4">
          <div className="cols">
            <h3>
              Team <span className="text-warning">Management </span>
            </h3>
            <p>
              We encourage volunteers to become a part of the youth family and
              bring positive change with in and people around them. VBD allows
          ...
          <div className="cols">
            <img
              src="https://p0.pxfuel.com/preview/252/779/697/achievement-agreement-blue-caucasian.jpg"
              alt=""
              className="rounded-3 img-fluid w-75"
            />
          </div>
        </div>
      </div>
